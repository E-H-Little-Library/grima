<div class='card ml-4 holding'>
  <div class='card-header'>
    <h2 class='card-title'>Holding #<?=$e($holding['holding_id'])?>
      <a href="../ChangeCallNumber/ChangeCallNumber.php?holding_id=<?=$e($holding['holding_id'])?>&mms_id=<?=$e($bib['mms_id'])?>&newField=<?=$e($newField)?>">(Change)</a>
  ...
  <div class='card-body'>
    <dl class="row">
      ...
      <dd class="col-md-10 library"><?=$e($holding['library_code'] )?></dd>
      <dt class="col-md-2 text-right location">Location:</dt>
      <dd class="col-md-10 location"><?=$e($holding['location_code'] )?></dd>
